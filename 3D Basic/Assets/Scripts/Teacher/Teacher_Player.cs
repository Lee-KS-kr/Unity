...
public class Teacher_Player : MonoBehaviour, IDead
{
    ...
    private TeacherController pc = null;   // 입력 처리용 클래스
    ...
    private void Awake()
    {
        ...
        pc = new TeacherController();     // Input Action Asset을 이용해 자동 생성한 클래스
        // PlayerDefault라는 액션맵에 있는 UseItem 액션이 start일 때 UseItem 함수 실행하도록 바인딩
    ...
    {
        pc.Player.Disable();     //액션 맵도 함께 비활성화
    }
